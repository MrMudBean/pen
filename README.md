...
[![version](<https://img.shields.io/npm/v/@mudbean/pen.svg?logo=npm&logoColor=rgb(0,0,0)&label=版本号&labelColor=rgb(73,73,228)&color=rgb(0,0,0)>)](https://www.npmjs.com/package/@mudbean/pen) [![issues 提交](<https://img.shields.io/badge/issues-提交-rgb(255,0,63)?logo=github>)](https://github.com/MrMudBean/pen/issues)
...
```ts
import { pen, colorText } from '@mudbean/pen';
...
```ts
import { redPen, bluePen } from '@mudbean/pen';
...
```ts
import { pen, redPen, boldPen } from '@mudbean/pen';
